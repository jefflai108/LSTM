...
def lstm():
	...
	model.add(LSTM(256, dropout=0.2, recurrent_dropout=0.2, input_shape=(None,20), return_sequences=True))
	model.add(LSTM(256, dropout=0.2, recurrent_dropout=0.2, input_shape=(None,20), return_sequences=True))
...
if __name__ == '__main__':
	...
	# concatenate('noisy_mfcc_1.txt', 'more_mfcc.txt', 'vad_1.txt', 'vad_2.txt')
	# lstm()